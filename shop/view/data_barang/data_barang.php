 <!-- Main content -->
            ...
            <div class="card">
              ...
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-lg">
                ...
                <table id="data_barang" class="table table-bordered table-striped">
                  ...
                  <?php
                  $no = 0;
                  $query = mysqli_query($koneksi,"SELECT * FROM tb_barang order by id desc");
                  ...
                  <tr>
                    ...
                    <a href="index.php?page=edit-data-barang&id=<?php echo $brg['id'];?>" class="btn btn-sm btn-success">Edit</a>
                    <a class="view-data btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-view" 
                    data-nama="<?php echo $brg['nama'];?>"
                    data-kode="<?php echo $brg['kode'];?>"
                    data-harga="<?php echo $brg['harga'];?>">View Data</a>  
                  </td>
                  </tr>
                 <?php } ?>
                  </tbody>
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form method="get" action="view/data_barang/tambah_data.php">
  ...
  if (result.isConfirmed) {
    window.location=("view/data_barang/hapus_data.php?id="+data_id);
  }
})
      }
    </script>